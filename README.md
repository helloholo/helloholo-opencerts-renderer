# HelloHolo OpenCerts Decentralized Renderer
...
Our certificate templates created from the [OpenCerts decentralized renderer](https://github.com/Open-Attestation/decentralized-renderer-react-template).
